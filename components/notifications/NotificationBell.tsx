...
export function NotificationBell({
  ...
  const fetchNotifications = useMemo(
    () => async () => {
      try {
        ...
        const json = (await response.json().catch(() => null)) as NotificationsApiResponse | null;
  ...
  return (
    <div ref={rootRef} className="ui-notificationBell">
      <button
        type="button"
        className={cx(buttonClassName, unreadCount > 0 && 'ui-notificationBellBtn--active')}
      ...
      {open ? (
        <div className={cx('ui-notificationPanel', panelClassName)}>
          <div className="ui-notificationPanel__header">
            <div>
              <div className="ui-body font-[var(--font-weight-bold)]">Notifiche</div>
          ...
          <div className="ui-notificationPanel__body">
            {loading ? (
              ...
              <div className="ui-notificationEmpty">Nessuna notifica per ora.</div>
            ) : (
              <div className="space-y-2">
                {items.map((item) => (
                  <button
                    ...
                    className={cx(
                      'ui-notificationItem',
                      !item.read_at && 'ui-notificationItem--unread'
                    )}
