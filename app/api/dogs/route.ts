...
export async function POST(request: Request) {
  try {
    ...
    // Taglia/difficoltà derivate dalla razza (o dalle razze di provenienza per i meticci).
    const breedProfile = resolveDogBreedProfile(dogInput.species, dogInput.breed, dogInput.origin_breeds);
